...
class InstallSchema implements InstallSchemaInterface {
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context){
        $setup->startSetup();
        $table_name = 'atopt_slider';
        /**
         * Create table 'atopt_slider'
         */
        $table = $setup->getConnection()->newTable($setup->getTable($table_name))
                ...
                ->setComment('Atopt Main Product Slider Table');
        $setup->getConnection()->createTable($table);
        // Create table for featured and additional slider products
        $table_name = 'atopt_slider_products';
        $table = $setup->getConnection()->newTable($setup->getTable($table_name))
            ->addColumn('slider_id',
                        \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
                        null,
            ...
            ->addForeignKey($setup->getFkName($table_name,'slider_id','atopt_slider','slider_id'),
                            'slider_id',
                            $setup->getTable('atopt_slider'),
                            'slider_id',
...
//        Create table for managing sliders and stores
        $table_name = 'atopt_slider_stores';
        $table = $setup->getConnection()->newTable($setup->getTable($table_name))
            ->addColumn('slider_id',
                        \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
                        null,
