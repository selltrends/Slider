...
namespace Atopt\Slider\Block\Adminhtml\Widget\Form\Field;
...
class WysiwygEditor extends Template implements RendererInterface
{
	...
	public function render(AbstractElement $element){
		...
		$html .= $this->getLayout()->createBlock(
            ...
            require([
                'jquery',
                'Atopt_Slider/js/wysiwyg/tiny_mce/setup'
            ], function(jQuery){
            var config = $config,
                editor;
            ...
            editor{$element->getHtmlId()} = new atoptSliderTinyMceWysiwygSetup(
                '{$element->getHtmlId()}',
                config
            );
