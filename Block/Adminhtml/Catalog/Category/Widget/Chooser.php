...
namespace Atopt\Slider\Block\Adminhtml\Catalog\Category\Widget;
...
class Chooser extends \Magento\Catalog\Block\Adminhtml\Category\Widget\Chooser
{
	...
	public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element){
		...
		$choooser = $this->getLayout()->createBlock('Magento\Widget\Block\Adminhtml\Widget\Chooser')->setElement($element)
			->setConfig($this->getConfig())->setFieldsetId($this->getFieldsetId())->setSourceURl($sourceUrl)
			->setUniqId($uniqId);
