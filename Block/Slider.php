...
use Atopt\Slider\Model\ProductSlider;
...
class Slider extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface {
     ...
     */
    protected $_template = 'Atopt_Slider::slider.phtml';
    /**
    ...
    * @var \Magento\Framework\Registry
     ...
     * @param \Atopt\Slider\Model\ResourceModel\ProductSlider\CollectionFactory $sliderCollectionFactory
     * @param \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Atopt\Slider\Model\ResourceModel\ProductSlider\CollectionFactory $sliderCollectionFactory,
    ...
    public function setSliderLocation($location, $hide = false){
        ...
        /**
         *  @var \Atopt\Slider\Model\ResourceModel\ProductSlider\Collection $sliderCollection
         */
        ...
        /**
         *  @var \Atopt\Slider\Model\ResourceModel\ProductSlider\Collection $sliderCollectionTimer
         */
     ...
     *
     * @param \Atopt\Slider\Model\ResourceModel\ProductSlider\Collection $sliderCollection
     *
     * @return $this
     */
    public function setSlider($sliderCollection)
    {
        foreach($sliderCollection as $slider):
            ...
            $this->append($this->getLayout()
                                ->createBlock('\Atopt\Slider\Block\Slider\Items')
                                ->setSlider($slider));
        endforeach;
        $this->addSwatchesCss();
        $this->addAjaxCartJs();
        ...
        if(!$this->getLayout()->getBlock("swatches-css")){
            if(!array_intersect($swatchesHandles,$currentHandles)){
                $block = $this->getLayout()->createBlock('Magento\Framework\View\Element\Template', 'swatches-css')
                        ->setTemplate('Atopt_Slider::swatches/css.phtml');
        ...
        if(!$this->getLayout()->getBlock("ajaxcart-js")){
            if(!array_intersect($swatchesHandles,$currentHandles)){
                $block = $this->getLayout()->createBlock('Magento\Framework\View\Element\Template', 'ajaxcart-js')
                        ->setTemplate('Atopt_Slider::ajax/js.phtml');
