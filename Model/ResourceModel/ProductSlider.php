...
class ProductSlider extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
     ...
     */
    const SLIDER_PRODUCTS_TABLE = 'atopt_slider_products';
    /**
     * Slider stores table
     */
    const SLIDER_STORES_TABLE = 'atopt_slider_stores';
    /**
     * @return void
     */
    protected function _construct()
    {
        $this->_init('atopt_slider','slider_id');
    }
    /**
    ...
    public function getSliderProducts($slider)
    {
        $select = $this->getConnection()->select()->from(
            $this->getTable('atopt_slider_products'),
            ['product_id', 'position']
        )->where(
            'slider_id = :slider_id'
        );
